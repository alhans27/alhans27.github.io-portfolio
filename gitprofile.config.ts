...
const CONFIG = {
  github: {
    username: 'alhans27', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Hanif S Al Amna',
    description: '',
    imageURL: '',
  },
  social: {
  ...
  educations: [
    {
      institution: 'Sebelas Maret Univeristy',
      degree: 'Bachelor',
      from: '2019',
      to: '2023',
    },
